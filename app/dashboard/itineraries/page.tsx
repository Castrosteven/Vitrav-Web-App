...
const ItineraryCard = (itinerary: Schema["Itenerary"]["type"]) => {
  return (
    <Link key={itinerary.id} href={`/dashboard/details/custom/${itinerary.id}`}>
...
const DyanmicItineraryCard = (itinerary: Schema["Itenerary"]["type"]) => {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden">
        <Image
          src={dynamicImage(itinerary.itineraryType! as ItineraryTypeEnum)}
          alt={itinerary.itineraryTitle}
          width={300}
          height={200}
          className="w-full h-92 object-cover"
    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Itineraries.map((itinerary) => {
          if (itinerary.isDynamic) {
            return <DyanmicItineraryCard {...itinerary} key={itinerary.id} />;
          } else {
            return <ItineraryCard key={itinerary.id} {...itinerary} />;
          }
        })}
      </div>
    </div>
